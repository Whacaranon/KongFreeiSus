...
delay(1, function()
    ...
    Combat:AddSlider("For ",0,1000,200,function(value)
    _G.Select_Size_Fov = value
            _G.Settings.Select_Size_Fov = value
            end)
            
    Combat:AddToggle("For",nil,function(value)
    _G.Select_Size_Fov = value
            _G.Settings.Select_Size_Fov = value
            end)
